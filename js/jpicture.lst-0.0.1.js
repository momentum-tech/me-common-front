function JPictureLst(data) {
	var _id = data.id;
	var _pictureLst = data.pictureLst;
	var _pictureSize = _pictureLst.length;
	var _uploadFile = data.uploadFile;
	
	var _entityId;
	
	var processing = false;
	
	var isEven = _pictureLst.length%2 == 0;
	...
	var _width = (document.body.clientWidth - _margin * (_pictureSize - 1))/_pictureSize - _margin * 2;
	_width = Math.min(_width, 300);
	
	var _imageHeight = _width/3*4;
	var _height = _imageHeight + 35;
